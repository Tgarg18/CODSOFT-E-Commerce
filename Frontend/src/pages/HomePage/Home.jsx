...
const Home = () => {
  ...
  useEffect(()=>{
          ...
          (async()=>{
            try{
              const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/products/getAllProducts`)
  ...
  useEffect(() => {
    (async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/catagory/getAllCatagory`);
   ...
   useEffect(() => {
    (async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_BACKEND_URL}/products/getSampleProducts`);
